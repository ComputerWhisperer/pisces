 ...
 *									 *
 *************************************************************************/
/*   material.h                Version 3.3     */
/*   Last Modification : 11/25/88  19:25:26 */
...
/*the number of regions (misnomer)*/
EXTERN int nmat;
...
#define INSULATE(A)	(((A) != Si) && ((A) != Poly))

EXTERN double mat_const[MAXMAT][25]; 		/*material constant values*/

EXTERN int mattyp[MAXMAT];		/*material type by region number*/
...
EXTERN double STgammar;		/* Ratio of surface tension coeff to visc*/
