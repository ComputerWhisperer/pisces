 ...
 *									 *
 *************************************************************************/
/*   diffuse.h                Version 3.4     */
/*   Last Modification : 9/22/88  11:26:28 */
...
EXTERN double net[MAXPNT];		/*net concentration at each point*/
EXTERN double *dnet[MAXIMP];		/*derivitive of the net concentration at each point*/
EXTERN double noni[MAXPNT];		/*n over ni at each point*/
