 ...
 * modified: mje -- stanford (sep 89) added G_SHINT, G_PAUSE
 */
...
#define  G_RESET  42
#define	 G_SHINT  43
#define  G_PAUSE  44	/* believe it not, we want this saved */
...
#define gshint(X,Y)   gplot2(G_SHINT, 0, X , Y ) /* plot size hint */
#define gpause()      gplot2(G_PAUSE, 0, 0., 0.) /*wait for user's ok to cont*/
